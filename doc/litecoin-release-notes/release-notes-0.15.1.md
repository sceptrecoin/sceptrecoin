Sceptrecoin Core version *0.15.1* is now available from:

  <https://download.sceptrecoin.org/sceptrecoin-0.15.1/>
...
A number of changes to the way Sceptrecoin Core deals with peer connections and invalid blocks
