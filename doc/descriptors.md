# Support for Output Descriptors in Sceptrecoin Core

Since Sceptrecoin Core v0.17, there is support for Output Descriptors. This is a
...
on Sceptrecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Sceptrecoin Core wallets, a convenience function `combo` is
