...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " sceptrecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  sceptrecoin-tx [options] <hex-tx> [commands]  Update hex-encoded sceptrecoin transaction\n" +
            "or:     sceptrecoin-tx [options] -create [commands]   Create hex-encoded sceptrecoin transaction\n" +
            "\n";
