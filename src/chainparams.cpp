...
{
    const char* pszTimestamp = "Rest in peace Josky Kiambukuta 1949-02-14 to 2021-03-07";
    const CScript genesisOutputScript = CScript() << ParseHex("040181710fa689ad5023690c81f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b19f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1615204954, 2000723384, 0x1e0ffff0, 1, 500 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa4b8765c7057224b0e63979fca05ebcbba5cf0b4b820943448606218ede29378"));
        ...
        //vSeeds.emplace_back("dnsseed.sceptrecointools.com");
        //vSeeds.emplace_back("dnsseed.sceptrecoinpool.org");
        ...
        checkpointData = {
            {
                {  0, uint256S("0xa4b8765c7057224b0e63979fca05ebcbba5cf0b4b820943448606218ede29378")},
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("test-a.sceptrecoin.org");
        //vSeeds.emplace_back("seed-b.sceptrecoin.loshan.co.uk");
        ...
        checkpointData = {
            {
                {0, uint256S("0xe6400652c007b047ac29260944a3e89464866bef273961bc13c411025f4e559c")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1615204954, 0, 0x207fffff, 1, 500 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4df91f0d7991c6247ee0214d8eedffb5a24e02eb3f84766bdc2968bb505f58c6"));
        assert(genesis.hashMerkleRoot == uint256S("0x9fe40ab878c6f03ae6f076c131d781924f2cb05ab3aa8e2305368cc0379ea806"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x4df91f0d7991c6247ee0214d8eedffb5a24e02eb3f84766bdc2968bb505f58c6")},
            }
        };
