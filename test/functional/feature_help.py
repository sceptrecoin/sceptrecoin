...
"""Verify that starting sceptrecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start sceptrecoin with -h for help text")
        ...
        self.log.info("Start sceptrecoin with -version for version information")
        ...
        self.log.info("Start sceptrecoind with -fakearg to make sure it does not start")
